...
class MambaVision(nn.Module):
    ...
    def __init__(self,
        ...
        self.patch_embed_5 = PatchEmbed(in_chans = 5, in_dim = in_dim, dim = dim)
    ...
    def forward_features(self, x, mask):
        image_feature = self.patch_embed(x)
        map_feature = self.patch_embed_5(mask)
        x = torch.add(image_feature, map_feature).clone()
