...
class FundusSeg_Loader(Dataset):
    def __init__(self, data_path, is_train, eyePacsTrainFiles, eyePacs_path):
        ...
        trainEyeQ = pd.read_csv('/content/drive/My Drive/SEBNet-main/Label_EyeQ_train.csv')
        testtEyeQ = pd.read_csv('/content/drive/My Drive/SEBNet-main/Label_EyeQ_test.csv')
    ...
    def __getitem__(self, index):
        ...
        if ssl == 1:
            ...
            eyeQ_path = self.eyePacs_path + self.eyeQFinalNames[index].split('.')[0] + '.png'
        ...
        if ssl == 1:
            ...
            image = image.transpose(2, 0, 1)
            label = np.array(np.zeros((256, 256)))
