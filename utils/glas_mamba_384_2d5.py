...
class FundusSeg_Loader(Dataset):
    def __init__(self, data_path, is_train):
        ...
        self.lbl_imgs_path = self.imgs_path[:34]
        self.unlbl_imgs_path = self.imgs_path[34:]
    ...
    def __getitem__(self, index):
        ...
        if ssl == 1:
            image_path = self.imgs_path[index] ## etiketliler 51'den 84'e kadar... dikkat... (51 ve 84 dahil)
            ...
            eyeQ_path = self.unlbl_imgs_path[index] ## etiketsizler 0'dan 50'ye kadar zaten (0 ve 50 dahil). Problem yok o yüzden...
...
class FundusSeg_Loader_Test(Dataset):
    def __init__(self, data_path):
        ...
        self.transform = A.Compose([A.Resize(384, 384, p = 1)])
        self.normalize = A.Compose([A.Normalize(mean, std), ToTensorV2()])
